...
@click.option(
    ...
    help=f'Number of DocDB documents to process (default: {DOC_LIMIT_DOCDB})'
)
@click.option(
    '--indico-limit', 
    default=DOC_LIMIT_INDICO, 
    help=f'Number of Indico documents to process (default: {DOC_LIMIT_INDICO})'
)
@click.option('--force', is_flag=True, help='Force reprocessing of existing documents')
def index(docdb_limit, indico_limit, force):
...
@click.option('--top-k', default=3, help='Number of similar documents to retrieve')
