...
/lus/flare/projects/LLM_for_DUNE/users/aditya/BALSAM/balsam_venv/bin/python3.10 /lus/flare/projects/LLM_for_DUNE/users/aditya/BALSAM/balsam_venv/lib/python3.10/site-packages/balsam/cmdline/launcher.py -j mpi -t 48  \
 --tag job_start=0  \
